        ...
        StringRequest stringRequest = new StringRequest(DELETE, MahasiswaAPI.URL_DELETE + npm, new
                Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        //Disini bagian jika response jaringan berhasil tidak terdapat error/gangguan
                        progressDialog.dismiss();
                        try {
                            //Mengubah response string menjadi object
                            JSONObject obj = new JSONObject(response);

//                            obj.getString("status") digunakan untuk mengambil pesan message dari response
...
//                            obj.getString("message") digunakan untuk mengambil pesan message dari response
            ...
            public void onErrorResponse(VolleyError error) {
                //Disini bagian jika response jaringa terdapat error
                progressDialog.dismiss();
